...
run_web() {
    ...
    echo trojan://"${PASSWORD}@${PROJECT_DOMAIN}.coderpad.io:443?security=tls&type=ws&path=${PATH_IN_LINK}#coderpad"
    echo "Trojan Password: ${PASSWORD}, Websocket Path: ${WSPATH}, Domain: ${PROJECT_DOMAIN}.coderpad.io, Port: 443"
    chmod +x ./web.js
